...
////////////////////////////////////////////////////////////////////////
    ...
    window.plugin.pogo.loadStorage = function()
    {
        ...
        window.plugin.pogo.usePogoMode = localStorage[plugin.pogo.KEY_POGO_MODE];
    ...
    window.plugin.pogo.optPogoMode = function(value)
    {
        ...
        console.log('usePogoMode 1', value);
        if (value == undefined || value == 'undefined'){
            v = window.plugin.pogo.usePogoMode;
        } else {
            localStorage[plugin.pogo.KEY_POGO_MODE] = value;
            window.plugin.pogo.usePogoMode = value;
            v = value;
        }
        console.log('usePogoMode 2', v);
        if (v === true || v == 'true'){ //pogo mode          
    ...
    window.plugin.pogo.setupContent = function()
    {
        ...
        plugin.pogo.htmlStar = '<span class="iconStar"><a class="pogoStar" accesskey="p" onclick="window.plugin.pogo.switchStarPortal(\'pokestop\');return false;" title="Mark this portal as a pokestop [p]"><span></span></a><a class="pogoGym" accesskey="g" onclick="window.plugin.pogo.switchStarPortal(\'gym\');return false;" title="Mark this portal as a PokeGym [g]"><span></span></a></span>';
    ...
    var setup = function()
    {
        ...
        $('head').append('<style>.pogo_theme .iconStar {position: absolute;top: 50px;z-index: 2;left: 46%;}</style>')
        ...
        // dark
        $('head').append('<style>.pogo_theme .ui-dialog {color: #c4fced;background-color: #266375 !important; background-image:linear-gradient(to right,  #4ab485, #266375) !important;}</style>')
        
        $('head').append('<style>.pogo_theme button, .pogo_theme #pogoSetbox a, .pogo_theme #sidebar .linkdetails a, .pogo_theme #toolbox a {border:0;margin-bottom: 15px;color: white;text-transform:uppercase;font-size: 0.9em;border-radius:30px;padding: 10px;background-image: linear-gradient(to right, #a1da95, #22cca9) !important}</style>')
